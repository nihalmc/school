...
if(isset($_POST['update_student']))
{
 ...
 $donor_id =mysqli_real_escape_string($con,$_POST['student_id']);
...
$query = "UPDATE school SET name='$name',age='$age' ,dbrith='$dbrith', phone='$phone',email='$email' WHERE id='$donor_id'";
...
$query ="INSERT INTO school(name,age,dbrith,phone,email)
 VALUES('$name','$age','$dbrith','$phone','$email')";
